...
/**
 * Servlet implementation class DeleteTreatmentDetails_SupportSystemsServlet
 */
@WebServlet("/DeleteTreatmentDetails_SupportSystemsServlet")
public class DeleteTreatmentDetails_SupportSystemsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DeleteTreatmentDetails_SupportSystemsServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			iTreatmentDetails.DeleteTreatmentDetails_supportSystemsByID(request.getParameter("treatmentDetailsID_SupportSystems"));
